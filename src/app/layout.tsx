    ...
    <html lang="en">
      <body>
        <nav style={{ background: '#ffffff', padding: '1rem 2rem', borderBottom: '1px solid var(--border-light)', display: 'flex', gap: '2rem', alignItems: 'center', boxShadow: '0 1px 3px rgba(0,0,0,0.05)', position: 'sticky', top: 0, zIndex: 50 }}>
          ...
          <Link href="/" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 500, padding: '0.5rem 1rem', borderRadius: '4px', transition: 'background 0.2s' }} onMouseEnter={e => e.currentTarget.style.background = 'var(--bg-highlight)'} onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>Dashboard</Link>
          <Link href="/upload" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 500, padding: '0.5rem 1rem', borderRadius: '4px', transition: 'background 0.2s' }} onMouseEnter={e => e.currentTarget.style.background = 'var(--bg-highlight)'} onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>Bulk Upload</Link>
